    ...
    !function(e, t) {
      ...
      return function(e) {
        ...
        e.exports = function(e2) {
          ...
          return t2.toString = function() {
            ...
            for (var r = {}, i = 0; i < this.length; i++) {
              var a = this[i][0];
              typeof a == "number" && (r[a] = true);
            }
            for (i = 0; i < e3.length; i++) {
              var o = e3[i];
              typeof o[0] == "number" && r[o[0]] || (n && !o[2] ? o[2] = n : n && (o[2] = "(" + o[2] + ") and (" + n + ")"), t2.push(o));
            }
          }, t2;
        };
      }, function(e, t, n) {
        ...
        e.exports = function(e2, t2) {
          ...
          (t2 = t2 || {}).attrs = typeof t2.attrs == "object" ? t2.attrs : {}, t2.singleton || typeof t2.singleton == "boolean" || (t2.singleton = o()), t2.insertInto || (t2.insertInto = "head"), t2.insertAt || (t2.insertAt = "bottom");
          var n2 = v(e2, t2);
        ...
        function _(e2, t2, n2) {
          var r2 = n2.css, i2 = n2.sourceMap, a2 = t2.convertToAbsoluteUrls === void 0 && i2;
        ...
        e.exports = function(e2) {
          ...
          return e2.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(e3, t3) {
            ...
            return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(a) ? e3 : (i = a.indexOf("//") === 0 ? a : a.indexOf("/") === 0 ? n + a : r + a.replace(/^\.\//, ""), "url(" + JSON.stringify(i) + ")");
          });
        };
      }, function(e, t, n) {
        "use strict";
