...
function usePopper({
  ...
  const setPopperEventListeners = (enabled) => {
    ...
    (_state$popperInstance = state.popperInstance) === null || _state$popperInstance === void 0 ? void 0 : _state$popperInstance.setOptions((options) => __spreadProps(__spreadValues({}, options), {
